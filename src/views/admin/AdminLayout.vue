...
const displayName = computed(() => authStore.profile?.full_name || 'Administrator')
      ...
      <div class="flex h-full flex-col p-4">
        <div class="mb-8 flex items-center gap-3 px-2">
          ...
          <div class="min-w-0 flex-1">
            <h2 class="truncate text-sm font-semibold tracking-tight text-zinc-900">CBT ATS</h2>
      ...
      >
        ...
        <div class="flex items-center gap-2 sm:gap-3">
          ...
          <div class="hidden text-right sm:block">
            <p class="text-[10px] font-medium uppercase tracking-wide text-zinc-400">Status</p>
            <p class="text-xs font-medium text-emerald-600">Operasional</p>
          </div>
        </div>
      </header>
